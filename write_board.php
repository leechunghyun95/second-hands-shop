...
<form action="write_board_ok.php" method="post" enctype="multipart/form-data">

<h5 class="mt-3">제목<h5>
<div class="input-group mb-3">
  <input type="text" class="form-control" placeholder="제목" aria-label="Recipient's username" aria-describedby="basic-addon2" name="title" required>
</div>
