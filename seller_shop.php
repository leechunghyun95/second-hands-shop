...
<body>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">판매자</li>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="seller_shop.php?category=상의" class="list-group-item">상의</a>
          <a href="seller_shop.php?category=하의" class="list-group-item">하의</a>
          <a href="seller_shop.php?category=아우터" class="list-group-item">아우터</a>
          <a href="seller_shop.php?category=신발" class="list-group-item">신발</a>
        </div>
      </div>
      <!-- Content Column -->
